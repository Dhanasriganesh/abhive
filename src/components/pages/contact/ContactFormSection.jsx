    ...
    <section className="relative overflow-hidden bg-white py-20 lg:py-28">
      <div className="container relative z-10 mx-auto px-4 lg:px-12">
        ...
        <div className="grid gap-8 lg:grid-cols-12 items-start">
          <div className="relative group overflow-hidden rounded-[40px] h-full min-h-[500px] lg:col-span-5">
            <img
              src={inTouchImage}
              alt="Connect"
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    required
                    className="w-full h-14 px-6 rounded-2xl bg-white border border-slate-200 text-sm focus:border-blue-600 focus:outline-none transition-all appearance-none"
                  >
