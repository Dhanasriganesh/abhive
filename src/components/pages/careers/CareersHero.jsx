...
import backgroundImage from '../../../assets/about-section/careers.webp';
...
const CareersHero = () => (
  ...
  >
    ...
    <div className="absolute inset-0 bg-[radial-gradient(circle_at_15%_20%,rgba(37,99,235,0.3),transparent_30%),radial-gradient(circle_at_85%_80%,rgba(239,68,68,0.3),transparent_34%)] z-0" />
    ...
    <div className="container relative z-10 mx-auto px-4 lg:px-12">
      <div className="grid lg:grid-cols-12 gap-8 items-end">
        <div className="lg:col-span-8">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-light text-white mb-8 leading-[1.1]">
              ...
              AI people can <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-red-400 font-normal">Trust</span>.
            </h1>
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              {signals.map((item, idx) => (
                <motion.div
                  ...
                  className="flex items-center gap-3 py-3 px-4 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20 text-[10px] font-bold uppercase tracking-widest text-white/90 hover:border-white/40 transition-colors"
                >
        ...
        >
          <div className="p-6 rounded-[32px] bg-white/10 backdrop-blur-xl border border-white/20 shadow-2xl relative overflow-hidden group">
            <div className="absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-blue-400 to-red-400" />
            <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-white/70 mb-5">Studio Vitality</p>

            <div className="space-y-3">
              {metrics.map((stat, idx) => (
                <div key={stat.label} className="relative group rounded-2xl border border-white/15 bg-slate-950/40 p-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-[10px] font-bold text-white uppercase tracking-widest">Growth First</p>
                  <p className="text-[10px] text-white/70 italic">"Scaling together"</p>
                </div>
              </div>
            </div>
          </div>
